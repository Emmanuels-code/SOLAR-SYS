...
const solarSystem = [
    ...
    // 1. Console.log the mass of Mercury
    console.log(planets.mercury.mass);
     

    // the result output is 0.055.....//
    
    
    // 2. Console.log the eccentricity of Venus
    console.log(venus.eccentricity);

    
    
    // 3. Console.log the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune (131)
    Console.log(parselnt(system.jupiter.satellites) + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites);
...
console.log(system.mercury.raduisp);
 the output is 2439
